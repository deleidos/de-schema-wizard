...
/**
 * 'Headless resources' are testing files that have a desired outcome for all tests.  The intent of this class is to allow test classes to 
...
public class HeadlessResource {
	...
	public HeadlessResource(String filePath, String expectedType, String expectedBodyContentType, InputStream stream, boolean detectorTestReady, boolean parserTestReady) {
