  ...
  .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      element.on('dragstart', function(event) {
        ...
        //console.log("event");
        //console.log(event);
        //console.log("event.srcElement.id.substr(2)");
        //console.log(event.srcElement.id.substr(2));
...
*/
      ...
      element.on('drop', function(event) {
        //console.log("\n\n\n********** onDrop before dragDrop **********");
        event = event.originalEvent || event;
        //console.log("event");
        //console.log(event);
        //console.log(event.currentTarget.attributes['node-label1'].value);
        //console.log(event.currentTarget.attributes['node-id'].value);
        //if (!isDropAllowed(event)) return true;
        ...
        */
        ...
        //TODO: changed index to position of dropped element
        //var index = event.currentTarget.id.substr(2);
        //TODO: changed index to id of dropped upon element
        var index = event.currentTarget.attributes['node-id'].value;
        //console.log("dropped upon node id: " + index);
        var label1 = event.currentTarget.attributes['node-label1'].value;
        //console.log("dropped upon node label1: " + label1);
        if (attr.dndDrop) {
          transferredObject = invokeCallback(attr.dndDrop, event, index, label1);
          if (!transferredObject) {
            return stopDragover();
          }
        }

        //console.log("\n\n\n********** onDrop after dragDrop **********");
        ...
        scope.$apply(function() {
            ...
            for (var i = transferredObject.length - 1; i >= 0; i--) {
                targetArray.splice(index, 0, transferredObject[i]);
            }
        });
